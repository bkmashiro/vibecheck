...
const ui = {
  en: {
    ...
    aboutScoreText: 'The score is unbounded — it accumulates for every AI signal detected. Line volume, burst speed, fix-fix chains, co-authorship, and CI failure hints all contribute.',
  ...
  zh: {
    ...
    timeline: '时间线',
    aboutScore: '关于分数',
    aboutScoreText: '分数无上限——每检测到一个 AI 信号就累加。行量、爆发速度、fix-fix 链、共同署名、CI 失败痕迹都会贡献分数。',
  ...
  ja: {
    ...
    timeline: 'タイムライン',
    aboutScore: 'スコアについて',
    aboutScoreText: 'スコアは上限なし──AIシグナルが検出されるたびに加算されます。コード量、バーストスピード、fix-fixチェーン、共同著者、CI失敗の痕跡すべてが貢献します。',
